...
import com.example.weatherapp4.databinding.ActivityMainBinding
import com.example.weatherapp4.models.WeatherModel
import com.example.weatherapp4.utilies.ApiUtilies
...
class MainActivity : AppCompatActivity() {
    ...
    private val apiKey = "06adfe91376806a04cde1b206ec09215"
    ...
    private fun getCityWeather(city:String){
        ...
        ApiUtilies.getApiInterface()?.getCityWeatherData(city, apiKey)?.enqueue(
    ...
    private fun fetchCurrentLocationWeather(latitude:String,longitude:String){
        ApiUtilies.getApiInterface()?.getCurrentWeatherData(latitude, longitude, apiKey)
    ...
    private fun setData(body:WeatherModel){
        binding.apply {
            ...
            sunsetValue.text = ts2td(body.sys.sunrise.toLong())
            pressureValue.text = body.main.humidity.toString()+"%"
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    private fun ts2td(toLong: Long): String {
